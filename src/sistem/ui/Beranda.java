...
public class Beranda extends javax.swing.JFrame {
    ...
    public Beranda() {
        initComponents();
        setVisible(true);
        setLocationRelativeTo(null);//mengset lokasi agar frame tampil di tengah layar
    }
    ...
    private void initComponents() {
        ...
        dtPrdk = new javax.swing.JButton();
        ...
        jLabel1.setText("UD. Toko Barokah");
        ...
        dtPrdk.setBackground(new java.awt.Color(255, 255, 255));
        dtPrdk.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        dtPrdk.setForeground(new java.awt.Color(0, 102, 102));
        dtPrdk.setText("Data Produk");
        dtPrdk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dtPrdkActionPerformed(evt);
            }
        });

        transaksiBtn.setBackground(new java.awt.Color(255, 255, 255));
        transaksiBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        transaksiBtn.setForeground(new java.awt.Color(0, 102, 102));
        ...
        konsumenBtn.setBackground(new java.awt.Color(255, 255, 255));
        konsumenBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        konsumenBtn.setForeground(new java.awt.Color(0, 102, 102));
        ...
        jLabel3.setText("Selamat Datang di Beranda . . .");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/foto/Marketing _Isometric.png"))); // NOI18N
    ...
    private void laporanBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_laporanBtnActionPerformed
        // TODO add your handling code here:
        new LaporanSistem().setVisible(true);//pindah frame saat klik btn
        dispose();//tutup(close) frame
    }//GEN-LAST:event_laporanBtnActionPerformed

    private void dtPrdkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dtPrdkActionPerformed
        // TODO add your handling code here:
        new DataProduk().setVisible(true);//pindah frame saat klik btn
        dispose();//tutup(close) frame
    }//GEN-LAST:event_dtPrdkActionPerformed

    private void transaksiBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_transaksiBtnActionPerformed
        // TODO add your handling code here:
        new Transaksi().setVisible(true);//pindah frame saat klik btn
        dispose();//tutup(close) frame
    ...
    private void konsumenBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_konsumenBtnActionPerformed
        // TODO add your handling code here:
        new DataPelanggan().setVisible(true);//pindah frame saat klik btn
        dispose();//tutup(close) frame
    ...
    private javax.swing.JButton dtPrdk;
